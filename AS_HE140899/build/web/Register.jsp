                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-10 ftco-animate">
                            <form action="#" class="billing-form">
                                <h3 class="mb-4 billing-heading">Tạo Tài Khoản</h3>
                                <div class="row align-items-end">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="hoten" value="${acc.username}" class="form-control">
                                        </div>
                                    </div>
                                    <div class="w-100"></div>
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input name="addressNo" type="text" class="form-control" placeholder="Số Đường">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <input name="homeNo" type="text" class="form-control" placeholder="Số Nhà">
                                        </div>
                                    </div>
                                    <div class="w-100"></div>
                                    <div class="col-md-6">
                            ...
                            <div class="row mt-5 pt-3 d-flex">
                                ...
                                <input style="width: auto; height: 50%" type="submit" value="Register" class="btn btn-primary py-3 px-4"/>
                            </div>
                        </div> <!-- .col-md-8 -->
                    </div>
                </div>
