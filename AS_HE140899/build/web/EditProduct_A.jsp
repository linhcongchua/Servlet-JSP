    ...
    <body>
        ...
        <section class="ftco-section">
            <form action="admin" method="POST">
                <input type="text" name="typeRequest" value="editProduct" hidden/>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-10 ftco-animate">
                                ...
                                <div class="row align-items-end">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="checkbox" name="available" value="ON" <c:if test="${product.available}">checked</c:if> class="form-control"/>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input name="rate" type="number" class="form-control" value="${product.rate}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="streetaddress">Sold: </label>
                                            <input name="sold" type="number" class="form-control" value="${product.sold}">
                                        </div>
                                    </div>
                                    <div class="w-100"></div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input name="ingredient" type="text" class="form-control" value="${product.ingredient}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                    ...
                                    <img id="blah" src="imageAssign/${product.pathImage}" alt="your image" />
                            ...
                            <div class="row mt-5 pt-3 d-flex">
                                ...
                                <input style="width: auto; height: 50%" type="submit" value="Lưu Thay Đổi" class="btn btn-primary py-3 px-4"/>
                            </div>
                        </div> <!-- .col-md-8 -->
                    </div>
                </div>
